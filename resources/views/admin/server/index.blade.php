...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Servers</li>
        </ol>
        ...
        <div class="card mb-1 p-3">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-end flex-wrap">
                            @can('serverAdd')
                                <a class="btn bg-gradient-dark mb-0" href="{{ route('server.create') }}">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-3">
                    <table id="serversTable" class="table align-items-center mb-0 w-100">
                        <thead>
                            <tr>
