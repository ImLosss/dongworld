            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-validation">
                        ...
                        <input class="form-control @error('episode_number') border border-danger rounded-3 @enderror" type="number" min="1" step="0.01" placeholder="{{ $nextEpisode ?? 1 }}" name="episode_number" value="{{ old('episode_number') }}" autofocus>
