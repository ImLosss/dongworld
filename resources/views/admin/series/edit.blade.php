                    ...
                    <div class="col-md-6">
                        <div class="form-group has-validation">
                            ...
                            <select name="release_day[]" id="release_day" class="form-control @error('release_day') border border-danger rounded-3 @enderror" multiple>
                                ...
                                <option value="0" {{ in_array('0', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Senin</option>
                                <option value="1" {{ in_array('1', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Selasa</option>
                                <option value="2" {{ in_array('2', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Rabu</option>
                                <option value="3" {{ in_array('3', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Kamis</option>
                                <option value="4" {{ in_array('4', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Jumat</option>
                                <option value="5" {{ in_array('5', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Sabtu</option>
                                <option value="6" {{ in_array('6', old('release_day', $series->release_day ?? [])) ? 'selected' : '' }}>Minggu</option>
                            </select>
                        </div>
                    </div>
                </div>
